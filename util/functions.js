...
module.exports = client => {
    ...
    client.updateDashboard = (guild, queue, lang) => {
        ...
        if(song) {
            ...
            const dashboardEmbed = new EmbedBuilder().setTitle(`${lang.DASHBOARD_SONG_NO_PLAYING}`).setDescription(`[Flopy](${elements.INVITE_FLOPY}) | [Flopy 2](${elements.INVITE_FLOPY2}) | [Flopy 3](${elements.INVITE_FLOPY3})`).setImage(elements.BANNER_PRIMARY).setFooter({ text: `${lang.DASHBOARD_SLASH_COMMANDS}` }).setColor(elements.COLOR_FLOPY)
