...
module.exports = client => {
    ...
    client.sendUpdateMessage = (guild, lang) => {
        ...
        const hideButton = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId("hide").setStyle(ButtonStyle.Secondary).setEmoji({ id: client.elements.EMOJI_UPDATE }))
    ...
    client.setupDashboard = (guild, channel, settings) => {
        ...
        const langButtons = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId("lang_en").setStyle(ButtonStyle.Secondary).setEmoji({ id: client.elements.EMOJI_LANG_EN }), new ButtonBuilder().setCustomId("lang_fr").setStyle(ButtonStyle.Secondary).setEmoji({ id: client.elements.EMOJI_LANG_FR }))
    ...
    client.updateDashboard = (guild, queue, lang) => {
        ...
        if(song) {
            ...
            const dashboardButtons = new ActionRowBuilder().addComponents(queue.playing ? new ButtonBuilder().setCustomId("pause").setStyle(ButtonStyle.Secondary).setEmoji({ id: client.elements.EMOJI_PAUSE }) : new ButtonBuilder().setCustomId("resume").setStyle(ButtonStyle.Primary).setEmoji({ id: client.elements.EMOJI_PLAY }), new ButtonBuilder().setCustomId("stop").setStyle(ButtonStyle.Secondary).setEmoji({ id: client.elements.EMOJI_STOP }), new ButtonBuilder().setCustomId("skip").setStyle(ButtonStyle.Secondary).setEmoji({ id: client.elements.EMOJI_SKIP }), new ButtonBuilder().setCustomId("repeat").setStyle(ButtonStyle.Secondary).setEmoji({ id: client.elements.EMOJI_REPEAT }), new ButtonBuilder().setCustomId("volume").setStyle(ButtonStyle.Secondary).setEmoji({ id: client.elements.EMOJI_VOLUME }))
            ...
            const dashboardButtons = new ActionRowBuilder().addComponents(new ButtonBuilder().setCustomId("resume").setStyle(ButtonStyle.Secondary).setEmoji({ id: client.elements.EMOJI_PLAY }).setDisabled(), new ButtonBuilder().setCustomId("stop").setStyle(ButtonStyle.Secondary).setEmoji({ id: client.elements.EMOJI_STOP }).setDisabled(), new ButtonBuilder().setCustomId("skip").setStyle(ButtonStyle.Secondary).setEmoji({ id: client.elements.EMOJI_SKIP }).setDisabled(), new ButtonBuilder().setCustomId("repeat").setStyle(ButtonStyle.Secondary).setEmoji({ id: client.elements.EMOJI_REPEAT }).setDisabled(), new ButtonBuilder().setCustomId("volume").setStyle(ButtonStyle.Secondary).setEmoji({ id: client.elements.EMOJI_VOLUME }).setDisabled())
