...
module.exports.run = async (client, message, args, settings, queue, lang) => {
    ...
    const likeEmbed = new Discord.MessageEmbed().setTitle(`${client.elements.EMOJI_LIKE}  ${lang.MESSAGE_SONG_LIKE.replace("$user", `**${member.displayName}**`)}`).setColor(client.elements.COLOR_PINK)
