module.exports.run = async (client, message, args, settings, queue, lang) => {
    ...
    client.distube.play(member.voice.channel, client.cache["query" + member.id], { textChannel: channel, member: member }).catch(error => client.distube.emit("error", channel, error))
}
module.exports.data = {
    name: "last",
