...
module.exports = async (client, queue, playlist) => {
	...
	if (songs[0] === playlist.songs[0]) return setTimeout(() => client.sendAdvancedNotification(destination, `${lang.MESSAGE_NOW_PLAYING}`, `${playlist.name}`, playlist.thumbnail, { editReply: true }), 1000);
