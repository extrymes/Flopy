...
module.exports = async (client, queue, song) => {
  ...
  if (songs.length - 1 > client.config.QUEUE_MAX_LENGTH) songs.splice(songs.indexOf(song) > 1 ? 1 : client.config.QUEUE_MAX_LENGTH + 1, songs.length - 1 - client.config.QUEUE_MAX_LENGTH);
