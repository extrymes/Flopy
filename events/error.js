module.exports = async (client, channel, error) => {
    ...
    if(error.message.includes("You do not have permission to join this voice channel") || error.message.includes("Cannot connect to the voice channel") || error.message.includes("The voice channel is full")) client.sendError(channel, `${lang.ERROR_JOIN_CHANNEL}`)
