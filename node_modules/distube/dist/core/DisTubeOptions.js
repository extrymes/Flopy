...
class Options {
    constructor(options) {
        ...
        this.pauseOnEmpty = opts.pauseOnEmpty;
    ...
    _validateOptions(options = this) {
        ...
        if (typeof options.pauseOnEmpty !== "boolean") {
            throw new __1.DisTubeError("INVALID_TYPE", "boolean", options.pauseOnEmpty, "DisTubeOptions.pauseOnEmpty");
        }
