...
class Options {
    constructor(options) {
        ...
        this.stopOnEmpty = opts.stopOnEmpty;
...
_Options_instances = new WeakSet(), _Options_validateOptions = function _Options_validateOptions(options = this) {
    ...
    if (typeof options.stopOnEmpty !== "boolean") {
        throw new __1.DisTubeError("INVALID_TYPE", "boolean", options.stopOnEmpty, "DisTubeOptions.stopOnEmpty");
    }
